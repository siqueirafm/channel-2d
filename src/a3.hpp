...
namespace channel {
  ...
  public:
    ...
    /**
     * \fn virtual double alower( const size_t i , const double u ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn virtual double a( const size_t i , const double u ) const throw( ExceptionObject )
     *
