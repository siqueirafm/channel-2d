...
#ifndef __curvebuilder__
#define __curvebuilder__
...
namespace channel {
  ...
  public: 
    ...
    /**
     * \fn CurveBuilder( size_t np , size_t nc , bool closed , double* lx , double* ly , double* ux , double* uy ) throw( ExceptionObject ) 
     *
     ...
     *
     * \brief Returns the logic value true if the b-spline curve is closed, and the logic value false otherwise.
     *
     * \return The logic value true if the b-spline curve is closed, and the logic value false otherwise.
     *
     */
    ...
    /**
     * \fn size_t get_number_of_constraints() const throw( ExceptionObject )
     *
    ...
    /**
     * \fn double get_control_value( const size_t i , const size_t v ) const throw( ExceptionObject ) 
     *
    ...
    /**
     * \fn size_t get_number_of_coefficients_in_the_ith_constraint( const size_t i ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn size_t get_coefficient_identifier( const size_t i , const size_t j ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn size_t get_coefficient_value( const size_t i , const size_t j ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn double get_bound_of_ith_constraint( const size_t i ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn bool is_equality( const size i ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn bool is_greater_than_or_equal_to( const size_t i ) const throw( ExceptionObject )
     *
    ...
    /**
     * \fn bool is_less_than_or_equal_to( const size_t i ) const throw( ExceptionObject )
     *
     * \brief Returns the  logic value true if the  i-th constraint is
    ...
    /**
     * \fn double get_lower_bound_on_second_difference_value( const size_t p , const size_t i , const size_t v ) const throw( ExceptionObject ) 
     *
    ...
    /**
     * \fn double get_upper_bound_on_second_difference_value( const size_t p , const size_t i , const size_t v ) const throw( ExceptionObject ) 
     *
  ...
  private:
    ...
    /**
     * \fn size_t compute_barycentric_coordinate_column_index( const size_t i ) const
     *
     * \brief Computes the  index of the linear  program matrix column
     ...
     *
     */
    size_t compute_barycentric_coordinate_column_index( const size_t i ) const ;
    ...
    /**
     * \fn void insert_nonlinear_terms_of_epiece_point_lower_bound( const size_t eqline , const double s , const size_t c , const std::vector< std::vector< std::vector< size_t > > >& sd , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu , const std::vector< std::vector< double > >& ncsec )
     *
    ...
    /**
     * \fn void insert_nonlinear_terms_of_epiece_point_lower_bound( const size_t eqline , const double s1 , const double s2 , const double u ,const size_t c , const std::vector< std::vector< std::vector< size_t > > >& sd1 , const std::vector< std::vector< std::vector< size_t > > >& sd2 , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu )
     *
     * \brief Inserts the coefficients  of the second difference terms
     * of the equation defining lower bounds for a given e-piece point
     * into  the matrix  associated  with an  instance  of the  Linear
     * Program (LP).  The  e-piece point belongs to  a e-piece segment
     * given ny  its two  e-piece endpoints. The  terms belong  to the
     * constraint that forces the the  channel corners to stay outside
     * the sleeve.
     *
     * \param eqline A counter for the number of constraints.
     * \param  s1 A  parameter  value identifying  an  endpoint of  an
     * e-piece segment.
     ...
     * \e s2.
     * \param  c  An  index  identifying a  c-segment  containing  the
     * e-piece point at parameter \e u.
     * \param   sd1  Array   with   the  LP   matrix  column   indices
     * corresponding  to   the  lower  and  upper   bounds  on  second
     * differences occurring in the  equation defining the the e-piece
     * point at parameter \e s1.
     * \param   sd2  Array   with   the  LP   matrix  column   indices
     * corresponding  to   the  lower  and  upper   bounds  on  second
     * differences occurring in the  equation defining the the e-piece
     * point at parameter \e s2.
     * \param nl Array of Cartesian  coordinates of outward normals to
     * the  supporting lines  of the  lower envelope  segments of  the
     * channel.
     * \param nu Array of Cartesian  coordinates of outward normals to
    ...
    /**
     * \fn void insert_nonlinear_terms_of_epiece_point_upper_bound( const size_t eqline , const double s , const size_t c , const std::vector< std::vector< std::vector< size_t > > >& sd , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu , const std::vector< std::vector< double > >& ncsec )
     *
    ...
    /**
     * \fn void insert_nonlinear_terms_of_epiece_point_upper_bound( const size_t eqline , const double s1 , const double s2 , const double u ,const size_t c , const std::vector< std::vector< std::vector< size_t > > >& sd1 , const std::vector< std::vector< std::vector< size_t > > >& sd2 , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu )
     *
     * \brief Inserts the coefficients  of the second difference terms
     * of the equation defining lower bounds for a given e-piece point
     * into  the matrix  associated  with an  instance  of the  Linear
    ...
    /**
     * \fn void insert_linear_terms_of_epiece_point_bounds( const size_t eqline , const double s , const double t , const size_t , const size_t c , const std::vector< std::vector< size_t > >& cp , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu , const std::vector< std::vector< double > >& ncsec )
     *
     ...
     * enforces a  channel corner to  stay on the boundary  or outside
     * the sleeve.
     *
     * \param eqline A counter for the number of constraints.
     * \param s1 A  parameter value identifying the  right endpoint of
     * the e-piece segment.
     * \param s2  A parameter value  identifying the left  endpoint of
     * the e-piece segment.
     * \param  t1 A  parameter  value identifying  the b-spline  curve
     * point that  corresponds to  the right  endpoint of  the e-piece
     * segment.
     * \param  t2 A  parameter  value identifying  the b-spline  curve
     * point  that corresponds  to the  left endpoint  of the  e-piece
     * segment.
     ...
     * \param   cp1  Array   with   the  LP   matrix  column   indices
     * corresponding to  the control  points of the  b-spline defining
     * the \f$p_1\f$-th piece of the curve.
     * \param   cp2  Array   with   the  LP   matrix  column   indices
     * corresponding to  the control  points of the  b-spline defining
     * the \f$p_2\f$-th piece of the curve.
     * \param nl Array of Cartesian  coordinates of outward normals to
     * the  supporting lines  of the  lower envelope  segments of  the
     * channel.
     * \param nu Array of Cartesian  coordinates of outward normals to
    ...
    /**
     * \fn void insert_rhs_of_sleeve_corners_in_channel_constraints( const size_t eqline , const size_t c , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu , const std::vector< std::vector< double > >& ncsec )
     *
     * \brief  Inserts  into the  matrix  associated  with the  Linear
    ...
    /**
     * \fn void insert_rhs_of_channel_corners_outside_sleeve_constraints( const size_t eqline , const size_t c , const std::vector< std::vector< double > >& nl , const std::vector< std::vector< double > >& nu )
     *
     * \brief  Inserts  into the  matrix  associated  with the  Linear
     * Program (LP) the right-hand side values of the constraints that
     * enforce a channel  corner to stay outside the  sleeve. The type
     * of each  constraint (equality or  inequality: ==, >= or  <=) is
     * also set here.
     *
     * \param eqline A counter for the number of constraints.
     * \param c An  index identifying the c-segment  the e-piece point
     ...
     * 
     */
    void insert_rhs_of_channel_corners_outside_sleeve_constraints(
                                                                  const size_t eqline ,
                                                                  const size_t c ,
                                                                  const std::vector< std::vector< double > >& nl ,
                                                                  const std::vector< std::vector< double > >& nu
