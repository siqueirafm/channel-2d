...
#ifndef __tabulatedfunction__
#define __tabulatedfunction__
...
namespace channel {
  ...
  public:
    ...
    /**
     * \fn virtual double alower( const size_t i , const double u ) const throw( ExceptionObject ) = 0
     *
     ...
     *
     */
    virtual double alower( const size_t i , const double u ) const throw( ExceptionObject ) = 0 ;


    /**
     * \fn virtual double aupper( const size_t i , const double u ) const throw( ExceptionObject ) = 0
     *
     * \brief Evaluates the piecewise linear function corresponding to
     ...
     *
     */
    virtual double aupper( const size_t i , const double u ) const throw( ExceptionObject ) = 0 ;


    /**
     * \fn virtual double a( const size_t i , const double u ) const throw( ExceptionObject ) = 0
     *
     ...
     *
     */
    virtual double a( const size_t i , const double u ) const throw( ExceptionObject ) = 0 ;
